...
/**
 * classe graphique de la mise a jour
 * @author USER
 */
public class MiseAJour extends JFrame  {
   ...
   //jfarme touchant a la mise a jour
    ...
    /**
     * fonction qui permet d'afficher les fenetres de choix entre modif , suppression et inserer
     */
        ...
        public void FX_MiseAJour()
    {
       ...
       jframe_MAJ.setVisible(true);
        ...
        /**
         * methode qui permet d'afficher le premier jpanel de modification
         * @throws SQLException
    ...
    /**
     * methode qui permet d'afficher le 1e jframe de suppression
     * @throws SQLException
     * @throws ClassNotFoundException 
     */
...
//la barre du haut
    ...
    /**
     * methode qui permet d'afficher le 1e jframe d'insertion
     * @throws SQLException
     * @throws ClassNotFoundException 
     */
    ...
    /**
     * affiche la derniere fenettre de suppression pour etre sur de vouloir supprimer
     * @param moncombo 
     */
